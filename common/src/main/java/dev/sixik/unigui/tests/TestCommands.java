...
//                })
    ...
    private static Widget examples(DefaultUIContext context) {
        ...
        path.layout(style -> style.size(LayoutConstraints.AUTO, 22.0f).flexGrow(1).flexShrink(1.0f));
        ...
        contentScroll.layout(style -> style.margin(8.0f, 0.0f, 0.0f, 0.0f).flexGrow(1).flexShrink(1.0f));
    ...
    private static OverlayLayer dockingEditorExample(DefaultUIContext context) {
        ...
        docking.addDocument("scene", "Scene", editorScenePane())
                ...
                .selectPane("scene");
        DockPane stylePane = docking.manager().findPane("style");
        if (stylePane != null) stylePane.dirty(true);
    ...
    private static Box dockingEditorToolbar(OverlayLayer layer, DockingRoot docking, Label status) {
        ...
        title.layout(style -> style.size(168.0f, 20.0f).align(Alignment.START, Alignment.CENTER).flexGrow(0).flexShrink(0.0f));
        ...
        addTab.layout(style -> style.size(76.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button floatPreview = new Button("Float Preview");
        floatPreview.layout(style -> style.size(104.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ToggleButton lockRedock = new ToggleButton("Lock Redock");
        lockRedock.layout(style -> style.size(96.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button modal = new Button("Modal");
        modal.layout(style -> style.size(64.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button render = new Button("Render: " + renderMode.get());
        render.layout(style -> style.size(106.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        floatPreview.onClick(event -> {
            ...
            window.layout(style -> style.size(238.0f, 122.0f).flexGrow(0).flexShrink(0.0f));
        ...
        modal.onClick(event -> {
            WindowWidget dialog = new WindowWidget("Save Layout",
                    ...
                    .fixedModal(true)
                    .closeOnOutsideClick(false);
            dialog.layout(style -> style.size(250.0f, 124.0f).flexGrow(0).flexShrink(0.0f));
            layer.addOverlay(dialog);
            dialog.openModal();
    ...
    private static Box dockingEditorStatusBar(Label status) {
        ...
        command.layout(style -> style.size(104.0f, 18.0f).align(Alignment.START, Alignment.CENTER).flexGrow(0).flexShrink(0.0f));
        status.layout(style -> style.align(Alignment.START, Alignment.CENTER));
    ...
    private static Widget editorScenePane() {
        VBox pane = new VBox();
        pane.spacing(8.0f);
        pane.layout(style -> style.margin(8.0f).flexGrow(0).flexShrink(0.0f));
        ...
        canvas.layout(style -> style.size(LayoutConstraints.AUTO, 126.0f).flexGrow(0).flexShrink(0.0f));
        Box base = panelBox(0.028f, 0.034f, 0.050f, 0.94f);
        base.layout(style -> style.align(Alignment.STRETCH, Alignment.STRETCH));
    ...
    private static Box editorCanvasNode(String label, float left, float top, float width, float height,
        ...
        text.layout(style -> style.align(Alignment.CENTER, Alignment.CENTER).size(LayoutConstraints.AUTO, LayoutConstraints.AUTO).flexGrow(1).flexShrink(1.0f));
        node.addChild(text);
        return node;
    }
    ...
    private static Widget editorGraphPane() {
        ...
        HBox nodes = new HBox();
        nodes.spacing(8.0f);
        nodes.layout(style -> style.size(LayoutConstraints.AUTO, 58.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static Widget editorPreviewPane() {
        ...
        previews.layout(style -> style.margin(8.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static Widget editorAssetsPane() {
        VBox pane = new VBox();
        pane.spacing(5.0f);
        pane.layout(style -> style.margin(7.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static Widget editorAssetRow(String text) {
        ...
        row.layout(style -> style.size(LayoutConstraints.AUTO, 24.0f).flexGrow(0).flexShrink(0.0f));
        Label label = new Label(text);
        label.layout(style -> style.margin(6.0f, 3.0f).align(Alignment.START, Alignment.CENTER).flexGrow(1).flexShrink(1.0f));
        row.addChild(label);
        return row;
    }
    ...
    private static Widget editorPropertyRow(String key, String value) {
        ...
        k.layout(style -> style.size(72.0f, 18.0f).align(Alignment.START, Alignment.CENTER).flexGrow(0).flexShrink(0.0f));
        Label v = new Label(value);
        v.layout(style -> style.size(LayoutConstraints.AUTO, 18.0f).align(Alignment.START, Alignment.CENTER).flexGrow(1).flexShrink(1.0f));
        row.addChild(k);
        row.addChild(v);
        return row;
    }
    ...
    private static Widget editorTextPane(String title, String text) {
        ...
        body.layout(style -> style.size(LayoutConstraints.AUTO, 84.0f).flexGrow(0).flexShrink(0.0f));
        pane.addChild(label);
        pane.addChild(body);
        return pane;
    }
    ...
    private static Box topBar(Breadcrumb path) {
        ...
        title.layout(style -> style.size(128.0f, 20.0f).align(Alignment.START, Alignment.CENTER).flexGrow(0).flexShrink(0.0f));
    ...
    private static Box sidebar(DefaultUIContext context, String[] names, WidgetBase[] pages, Breadcrumb path) {
        VBox nav = new VBox();
        nav.spacing(6.0f);
        nav.layout(style -> style.margin(6.0f).flexGrow(0).flexShrink(0.0f));
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            button.layout(style -> style.size(LayoutConstraints.AUTO, 21.0f).flexGrow(0).flexShrink(0.0f));
        ...
        sep.layout(style -> style.size(LayoutConstraints.AUTO, 1.0f).margin(0.0f, 3.0f).flexGrow(0).flexShrink(0.0f));
        nav.addChild(sep);

        nav.addChild(debugControls(context));

        Box box = panelBox(0.033f, 0.038f, 0.052f, 0.94f);
        box.layout(style -> style.size(176.0f, LayoutConstraints.AUTO).flexGrow(0).flexShrink(0.0f));
    ...
    private static VBox debugControls(DefaultUIContext context) {
        ...
        controls.layout(style -> style.flexGrow(0).flexShrink(0.0f));
        ...
        debug.layout(style -> style.size(LayoutConstraints.AUTO, 20.0f).flexGrow(0).flexShrink(0.0f));
        ...
        render.layout(style -> style.size(LayoutConstraints.AUTO, 20.0f).flexGrow(0).flexShrink(0.0f));
        render.onClick(event -> {
            changeMode.run();
            render.text("Render: " + renderMode.get());
        });
        ...
        anchor.layout(style -> style.size(LayoutConstraints.AUTO, 20.0f).flexGrow(0).flexShrink(0.0f));
        ...
        scale.layout(style -> style.size(LayoutConstraints.AUTO, 20.0f).flexGrow(0).flexShrink(0.0f));
        scale.onClick(event -> {
        ...
        window.layout(style -> style.size(LayoutConstraints.AUTO, 20.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static Box statusBar() {
        ...
        text.layout(style -> style.margin(8.0f, 4.0f).size(LayoutConstraints.AUTO, 16.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static VBox widgetsPage() {
        ...
        primary.layout(style -> style.size(76.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        search.layout(style -> style.size(150.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        ComboBox combo = new ComboBox()
                ...
                .silentSelectedIndex(0);
        combo.layout(style -> style.size(150.0f, LayoutConstraints.AUTO).flexGrow(0).flexShrink(0.0f));
        ...
        comfortable.layout(style -> style.size(104.0f, 20.0f).flexGrow(0).flexShrink(0.0f));
        detailed.layout(style -> style.size(82.0f, 20.0f).flexGrow(0).flexShrink(0.0f));
        ...
        slider.layout(style -> style.size(150.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ProgressBar progress = new ProgressBar().range(0.0f, 100.0f).value(42.0f);
        progress.layout(style -> style.size(112.0f, 12.0f).align(Alignment.START, Alignment.CENTER).flexGrow(0).flexShrink(0.0f));
        NumberField number = new NumberField().range(0.0d, 100.0d).value(42.0d);
        number.layout(style -> style.size(76.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        spinner.layout(style -> style.size(24.0f, 24.0f).flexGrow(0).flexShrink(0.0f));
        ...
        colorPicker.layout(style -> style.size(116.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Label pickerStatus = new Label("Pickers: waiting for change");
        pickerStatus.layout(style -> style.size(260.0f, 16.0f).flexGrow(0).flexShrink(0.0f));
        ...
        dateTime.layout(style -> style.flexGrow(0).flexShrink(0.0f));
    ...
    private static VBox layoutPage() {
        ...
        split.layout(style -> style.size(LayoutConstraints.AUTO, 88.0f).flexGrow(0).flexShrink(0.0f));
        ...
        tabs.layout(style -> style.size(LayoutConstraints.AUTO, 94.0f).flexGrow(0).flexShrink(0.0f));
        ...
        dockingActions.layout(style -> style.flexGrow(0).flexShrink(0.0f));
        Label dockingStatus = new Label("Snapshot: not captured");
        dockingStatus.layout(style -> style.size(260.0f, 18.0f).flexGrow(0).flexShrink(0.0f));
        Button saveDockLayout = new Button("Snapshot");
        saveDockLayout.layout(style -> style.size(82.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button restoreDockLayout = new Button("Restore");
        restoreDockLayout.layout(style -> style.size(76.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        accordion.layout(style -> style.size(LayoutConstraints.AUTO, LayoutConstraints.AUTO).flexGrow(0).flexShrink(0.0f));
        ...
        picker.layout(style -> style.size(190.0f, LayoutConstraints.AUTO).flexGrow(0).flexShrink(0.0f));
        ...
        view.layout(style -> style.size(LayoutConstraints.AUTO, 70.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static OverlayLayer dockingWindowsPage() {
        ...
        docking.layout(style -> style.size(LayoutConstraints.AUTO, 176.0f).flexGrow(0).flexShrink(0.0f));
        ...
        actions.layout(style -> style.flexGrow(0).flexShrink(0.0f));
        Button addDoc = new Button("Add doc");
        addDoc.layout(style -> style.size(72.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button floatTool = new Button("Float inspector");
        floatTool.layout(style -> style.size(108.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button modalButton = new Button("Modal");
        modalButton.layout(style -> style.size(68.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button snapshot = new Button("Snapshot");
        snapshot.layout(style -> style.size(82.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button restore = new Button("Restore");
        restore.layout(style -> style.size(74.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        WindowWidget floatingInspector = new WindowWidget("Floating Inspector",
                ...
                .closeOnOutsideClick(false);
        floatingInspector.layout(style -> style.size(230.0f, 118.0f).flexGrow(0).flexShrink(0.0f));
        WindowWidget modal = new WindowWidget("Docking Modal",
                ...
                .modal(true)
                .closeOnOutsideClick(false);
        modal.layout(style -> style.size(230.0f, 118.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static Box layoutV3SmokeSection() {
        VBox smoke = new VBox();
        smoke.spacing(8.0f);
        smoke.layout(style -> style.flexGrow(0).flexShrink(0.0f));

        Label hint = new Label("Layout V3 is the default layout path for these widgets.");
        hint.layout(style -> style.size(LayoutConstraints.AUTO, 22.0f).align(Alignment.START, Alignment.CENTER).flexGrow(1).flexShrink(1.0f));
        ...
        row.layout(style -> style.size(LayoutConstraints.AUTO, 44.0f).flexGrow(0).flexShrink(0.0f));
        ...
        WrapPanel cards = wrap();
        cards.layout(style -> style.size(LayoutConstraints.AUTO, 92.0f).flexGrow(0).flexShrink(0.0f));
        ...
        stack.layout(style -> style.size(LayoutConstraints.AUTO, 64.0f).flexGrow(0).flexShrink(0.0f));
        ...
        split.layout(style -> style.size(LayoutConstraints.AUTO, 76.0f).flexGrow(0).flexShrink(0.0f));
        smoke.addChild(section("V3 SplitPanel panes", split));

        VBox nestedPanels = new VBox();
        nestedPanels.spacing(5.0f);
        nestedPanels.layout(style -> style.size(LayoutConstraints.AUTO, 86.0f).flexGrow(0).flexShrink(0.0f));
        HBox nestedRow = new HBox();
        nestedRow.spacing(6.0f);
        nestedRow.layout(style -> style.padding(4.0f).alignItems(Align.CENTER));
        nestedRow.layout(style -> style.size(LayoutConstraints.AUTO, 38.0f).flexGrow(0).flexShrink(0.0f));
        ...
        nestedColumn.layout(style -> style.size(LayoutConstraints.AUTO, 38.0f).flexGrow(0).flexShrink(0.0f));
        ...
        edgeCanvas.layout(style -> style.size(LayoutConstraints.AUTO, 72.0f).flexGrow(0).flexShrink(0.0f));
        Box edgeBack = panelBox(0.030f, 0.042f, 0.062f, 0.92f);
        edgeBack.layout(style -> style.align(Alignment.STRETCH, Alignment.STRETCH));
        Button edgePopupAnchor = new Button("Edge popup");
        edgePopupAnchor.layout(style -> style.size(96.0f, 22.0f).align(Alignment.END, Alignment.END).margin(0.0f, 0.0f, 6.0f, 6.0f).flexGrow(0).flexShrink(0.0f));
        ...
        multiOverlayCanvas.layout(style -> style.size(LayoutConstraints.AUTO, 88.0f).flexGrow(0).flexShrink(0.0f));
        Box multiOverlayBack = panelBox(0.026f, 0.034f, 0.052f, 0.92f);
        multiOverlayBack.layout(style -> style.align(Alignment.STRETCH, Alignment.STRETCH));
        Button menuAnchor = new Button("Menu");
        menuAnchor.layout(style -> style.size(62.0f, 22.0f).align(Alignment.START, Alignment.START).margin(8.0f, 8.0f, 0.0f, 0.0f).flexGrow(0).flexShrink(0.0f));
        Button tooltipAnchor = new Button("Tip");
        tooltipAnchor.layout(style -> style.size(54.0f, 22.0f).align(Alignment.CENTER, Alignment.CENTER).flexGrow(0).flexShrink(0.0f));
        Button inspectorAnchor = new Button("Inspect");
        inspectorAnchor.layout(style -> style.size(72.0f, 22.0f).align(Alignment.END, Alignment.END).margin(0.0f, 0.0f, 8.0f, 8.0f).flexGrow(0).flexShrink(0.0f));
        Button openAllOverlays = new Button("Open all");
        openAllOverlays.layout(style -> style.size(78.0f, 22.0f).align(Alignment.END, Alignment.START).margin(0.0f, 8.0f, 8.0f, 0.0f).flexGrow(0).flexShrink(0.0f));
        ...
        ComboBox clippedDropDown = new ComboBox()
                ...
                .silentSelectedIndex(0)
                .useOverlay();
        clippedDropDown.layout(style -> style.size(150.0f, LayoutConstraints.AUTO).flexGrow(0).flexShrink(0.0f));
        ...
        clippedScroll.layout(style -> style.size(LayoutConstraints.AUTO, 58.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static VBox dataPage() {
        ...
        list.layout(style -> style.size(LayoutConstraints.AUTO, 118.0f).flexGrow(0).flexShrink(0.0f));
        ...
        table.columns(List.of(
                ...
                new VirtualTableColumn(tableHeaderText("Score"), 64.0f)
                        .align(Alignment.END, Alignment.CENTER).overflowMode(TextOverflowMode.SHRINK_TO_FIT)));
        ...
        sparkline.layout(style -> style.size(160.0f, 40.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static OverlayLayer overlaysPage() {
        ...
        tooltipAnchor.layout(style -> style.size(82.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button popupAnchor = new Button("Popup");
        popupAnchor.layout(style -> style.size(76.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button windowButton = new Button("Window");
        windowButton.layout(style -> style.size(76.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button modalButton = new Button("Modal");
        modalButton.layout(style -> style.size(76.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button menuButton = new Button("Context");
        menuButton.layout(style -> style.size(82.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        Button toastButton = new Button("Toast");
        toastButton.layout(style -> style.size(72.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ToggleButton freeDrag = new ToggleButton("Free drag");
        freeDrag.layout(style -> style.size(86.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        windowStatus.layout(style -> style.size(360.0f, 16.0f).flexGrow(0).flexShrink(0.0f));
        ...
        WindowWidget window = new WindowWidget("Example Window", samplePane("Dialog body", "Drag the title bar, or close with x."))
                ...
                .closeOnOutsideClick(false);
        window.layout(style -> style.size(220.0f, 124.0f).flexGrow(0).flexShrink(0.0f));
        WindowWidget modal = new WindowWidget("Modal Window", samplePane("Modal body", "Input below this dialog is blocked until it closes."))
                ...
                .modal(true)
                .closeOnOutsideClick(false);
        modal.layout(style -> style.size(240.0f, 132.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static VBox textPage() {
        ...
        clipped.layout(style -> style.size(260.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
        ...
        sdf.layout(style -> style.size(LayoutConstraints.AUTO, 26.0f).flexGrow(0).flexShrink(0.0f));
        ...
        mixed.richText(RichText.builder()
                ...
                .build());
        mixed.layout(style -> style.size(LayoutConstraints.AUTO, 30.0f).flexGrow(0).flexShrink(0.0f));
        ...
        RichTextView richTextView = new RichTextView(RichText.builder()
                ...
                .build());
        richTextView.layout(style -> style.size(LayoutConstraints.AUTO, 42.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static VBox minecraftPage() {
        ...
        swapItem.layout(style -> style.size(82.0f, 22.0f).flexGrow(0).flexShrink(0.0f));
    ...
    private static VBox page(String title, String subtitle) {
        VBox page = new VBox();
        page.spacing(8.0f);
        page.layout(style -> style.margin(8.0f));
        page.layout(style -> style.flexGrow(1).flexShrink(1.0f));
        ...
        text.layout(style -> style.size(LayoutConstraints.AUTO, 34.0f).flexGrow(0).flexShrink(0.0f));
        page.addChild(text);
        return page;
    }
    ...
    private static Box infoCard(String title, String body) {
        ...
        card.layout(style -> style.size(160.0f, 76.0f).flexGrow(0).flexShrink(0.0f));
